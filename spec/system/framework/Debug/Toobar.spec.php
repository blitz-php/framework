...
describe('Toolbar', function() {
    ...
    describe('prepare', function() {
        it('doit respecter disable_on_headers', function() {
        ...
        it("devrait s'injecter normalement sans en-tête ignoré", function() {
            $this->config->disable_onHeaders = ['HX-Request' => 'true'];
        ...
        it('doit avorter si les en-têtes ont déjà été envoyés', function() {
        ...
        it('doit avorter si le type de contenu natif n\'est pas HTML', function() {
        ...
        it('doit être interrompu si le contenu natif est une pièce jointe', function() {
        ...
        it('devrait fonctionner avec l\'en-tête HTML natif', function() {
