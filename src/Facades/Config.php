 ...
 * @method static $this ghost(array|string $key, ?\Nette\Schema\Schema $schema = null) Rend disponible un groupe de configuration qui n'existe pas (pas de fichier de configuration). Ceci est notament utilse pour definir des configurations à la volée
 *
